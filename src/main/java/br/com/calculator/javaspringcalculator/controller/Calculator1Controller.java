...
public class Calculator1Controller {
	...
	public String calculator(@RequestParam(value = "num1") String num1, @RequestParam(value = "num2") String num2, @RequestParam(value = "oper") String oper) {
		...
		Double res = calculatorServices.executeCalculation(Double.valueOf(num1), Double.valueOf(num2), oper);
						
		calculatorServices.saveCalculation(new Operation(Double.valueOf(num1), Double.valueOf(num2), oper, res));
